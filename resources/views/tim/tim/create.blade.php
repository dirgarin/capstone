            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('tim.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="mahasiswa1_id" class="form-label">Mahasiswa 1</label>
                        ...
                        <div class="mb-3">
                            <label for="mahasiswa2_id" class="form-label">Mahasiswa 2</label>
                        ...
                        <div class="mb-3">
                            <label for="mahasiswa3_id" class="form-label">Mahasiswa 3</label>
